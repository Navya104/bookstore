    ...
    return (
        <div className='fixed bg-black opacity-60 top-0 left-0 right-0 bottom-0 z-50 flex justify-center items-center'
            ...
            <div onClick={(event) => event.stopPropagation()} className='w-[600px] max-w-full h-[400px] bg-white rounded-xl p-4 flex flex-col relative'>
                <AiOutlineClose className='absolute right-6 top-6 text-3xl text-red-600 cursor-pointer' onClick={onClose}></AiOutlineClose>
                <h2 className="w-fit px-4 py-1 bg-red-300 rounded-lg">{item.publishedYear}</h2>
